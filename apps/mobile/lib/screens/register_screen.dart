...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Future<void> _submit() async {
    ...
    setState(() => _busy = true);
    try {
      final result = await widget.authApi.registerCoach(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Antrenör kaydı')),
      body: SafeArea(
        child: Center(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      textCapitalization: TextCapitalization.words,
                      decoration: const InputDecoration(
                        labelText: 'Kulüp adı (opsiyonel)',
                        helperText: 'Doldurursan kulüp de oluşturulur',
                        border: OutlineInputBorder(),
